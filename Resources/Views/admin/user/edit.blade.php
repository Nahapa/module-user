...
<section class="dash_content_app">
        ...
        <div class="dash_content_app_header_actions">
            <nav class="dash_content_app_breadcrumb">
                <ul>
                    ...
                    <li class="separator icon-angle-right icon-notext"></li>
                    <li><a href="{{ route('admin.user.edit', $user->id) }}" class="text-primary">Editar Usuário</a></li>
                </ul>
            </nav>
        </div>
    </header>
    ...
    <div class="dash_content_app_box">
        <div class="nav">
            ...
            <form class="app_form" action="{{ route('admin.user.update', $user->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
